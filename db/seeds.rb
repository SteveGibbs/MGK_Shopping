...
s4 = Product.create product_name: 'Pink-Stitched', price: 45, product_desc1: 'Handcrafted from genuine leather, our collections feature both stitched leather straps for a classic look and clean-cut leather straps for a modern look. All of our leather straps are interchangeable and due to an innovative pin mechanism alternating between your favourite styles is only a matter of seconds.', image: 'strap_seam_pink_rose_3_1.png' s5 = Product.create product_name: 'Black-Clean', price: 45, product_desc1: 'Handcrafted from genuine leather, our collections feature both stitched leather straps for a classic look and clean-cut leather straps for a modern look. All of our leather straps are interchangeable and due to an innovative pin mechanism alternating between your favourite styles is only a matter of seconds.', image: 'strap_black_silver_4.png'
